...
export default function CtaBanner() {
  return (
    <section id="contact" className="scroll-mt-20 border-t border-blush/50 py-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          <div className="rounded-2xl bg-plum px-8 sm:px-10 py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-8">
            <div>
            ...
            <a
              href="mailto:info@aksisys.com"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white text-plum text-[14px] font-semibold rounded-xl hover:bg-bloom transition-colors shrink-0"
            >
              Get in Touch
