      ...
      <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-bloom/40 bg-cream/60 backdrop-blur-sm px-4 py-1.5 mb-8">
            ...
            <span className="text-[12px] font-semibold text-plum/60">
          ...
          <p className="text-[15px] sm:text-[16px] text-plum/45 leading-[1.75] max-w-md mb-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              href="#services"
              className="inline-flex items-center gap-2 px-6 py-3.5 text-plum/60 text-[14px] font-semibold rounded-xl border border-bloom/40 bg-cream/40 hover:bg-cream/80 hover:border-bloom/60 transition-colors"
            >
              Explore Services
            </a>
          </div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-x-5 gap-y-2">
            {["15+ years of expertise", "98% client retention", "Pan-India presence"].map((t) => (
              <span key={t} className="flex items-center gap-1.5 text-[12px] text-plum/35">
                <svg className="h-3.5 w-3.5 text-rose/60 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="w-full lg:w-[440px] lg:shrink-0 relative py-8 lg:py-6">
          ...
          {/* Main card */}
          <div className="relative rounded-2xl border border-bloom/30 bg-cream/50 backdrop-blur-sm shadow-[0_16px_60px_rgba(89,66,70,0.08)] overflow-hidden">
            {/* Header */}
            <div className="flex items-center gap-2 px-5 py-3 border-b border-bloom/20 bg-cream/60">
              <div className="h-2.5 w-2.5 rounded-full bg-rose/50" />
              <div className="h-2.5 w-2.5 rounded-full bg-petal/60" />
              <div className="h-2.5 w-2.5 rounded-full bg-bloom/50" />
              <div className="ml-3 flex-1 h-5 rounded-md bg-bloom/15 flex items-center justify-center">
                <span className="text-[9px] font-medium text-plum/25 tracking-wide">aksassociates.com</span>
              </div>
            </div>
            ...
            <div className="p-5 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] text-plum/30 uppercase tracking-wider font-medium">Portfolio Overview</p>
                  <p className="text-[22px] font-bold text-plum/80 mt-0.5">₹248 Cr</p>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-plum/25 mt-0.5">YoY Growth</p>
                </div>
              </div>
              ...
              <div className="flex items-end gap-1.5 h-16">
                {[35, 45, 30, 55, 40, 65, 50, 70, 60, 80, 55, 75].map((h, i) => (
                  <div
                    key={i}
                    className="flex-1 rounded-sm bg-gradient-to-t from-rose/30 to-rose/10"
                    style={{ height: `${h}%` }}
                  />
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={s.name} className="flex items-center justify-between py-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-medium text-plum/60">{s.name}</span>
                    </div>
                    <span className="text-[10px] font-medium text-plum/30">{s.status}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div
            className="absolute -bottom-4 -left-3 lg:-left-6 z-10 w-56 rounded-xl border border-bloom/30 bg-cream/80 backdrop-blur-sm shadow-[0_8px_30px_rgba(89,66,70,0.10)] p-4"
          ...
          >
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <div>
                <p className="text-[11px] font-semibold text-plum/70">Rahul Mehta</p>
                <p className="text-[9px] text-plum/30">CEO, TechVentures</p>
              </div>
            </div>
            <p className="text-[11px] text-plum/40 leading-snug italic">
              &ldquo;AKS transformed our compliance framework. Exceptional service.&rdquo;
            </p>
            <div className="flex gap-0.5 mt-2">
              {Array.from({ length: 5 }).map((_, i) => (
                <svg key={i} className="h-3 w-3 text-rose/60" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div
            className="absolute -top-3 -right-2 lg:-right-5 z-10 w-44 rounded-xl border border-bloom/30 bg-cream/80 backdrop-blur-sm shadow-[0_8px_30px_rgba(89,66,70,0.10)] p-4"
            style={{ animation: "float-b 5s ease-in-out 1s infinite" }}
          >
            <div className="flex items-center gap-1.5 mb-2">
              <svg className="h-3.5 w-3.5 text-rose/50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
              <span className="text-[10px] font-bold text-plum/40 uppercase tracking-wider">Compliance</span>
            </div>
            <p className="text-[20px] font-bold text-plum/70">100%</p>
            <p className="text-[10px] text-plum/30 mt-0.5">Audit pass rate</p>
          ...
          <div
            className="absolute -bottom-2 right-3 lg:right-0 z-10 flex items-center gap-2 rounded-full border border-bloom/30 bg-cream/80 backdrop-blur-sm shadow-lg pl-2 pr-4 py-1.5"
          ...
          >
            ...
            <span className="text-[10px] text-plum/40"><span className="font-bold text-plum/60">50+</span> advisors</span>
          </div>
        </div>
      </div>
    </section>
