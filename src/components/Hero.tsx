    ...
    <section className="relative px-4 sm:px-6 lg:px-8 pt-20 sm:pt-28 pb-20 sm:pb-28 overflow-x-clip">
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="inline-flex items-center gap-2.5 rounded-full border border-blush bg-white/80 backdrop-blur-sm px-4 py-1.5 mb-8 shadow-sm">
            <div className="flex -space-x-1.5">
              <div className="h-5 w-5 rounded-full bg-rose border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">A</div>
              <div className="h-5 w-5 rounded-full bg-mauve border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">K</div>
              <div className="h-5 w-5 rounded-full bg-plum border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">S</div>
            </div>
        ...
        <div className="w-full lg:w-[440px] lg:shrink-0 relative py-8 lg:py-6">
          ...
          <div className="relative rounded-2xl border border-blush/80 bg-white shadow-[0_16px_60px_rgba(0,0,0,0.06)] overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-5 py-3 border-b border-blush/50 bg-bloom/40">
              ...
              <div className="ml-3 flex-1 h-5 rounded-md bg-blush/30 flex items-center justify-center">
                <span className="text-[9px] font-medium text-plum/40 tracking-wide">aksassociates.com</span>
              </div>
            </div>
            ...
            <div className="p-5 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] text-plum/45 uppercase tracking-wider font-medium">Portfolio Overview</p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-plum/40 mt-0.5">YoY Growth</p>
                </div>
              </div>
          ...
          <div
            className="absolute -bottom-4 -left-3 lg:-left-6 z-10 w-56 rounded-xl border border-blush/80 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.08)] p-4"
          ...
          >
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <div>
                <p className="text-[11px] font-semibold text-plum">Rahul Mehta</p>
                <p className="text-[9px] text-plum/45">CEO, TechVentures</p>
              </div>
            </div>
            <p className="text-[11px] text-plum/55 leading-snug italic">
          ...
          <div
            className="absolute -top-3 -right-2 lg:-right-5 z-10 w-44 rounded-xl border border-blush/80 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.08)] p-4"
          ...
          >
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <span className="text-[10px] font-bold text-plum/60 uppercase tracking-wider">Compliance</span>
            </div>
            <p className="text-[20px] font-bold text-plum">100%</p>
            <p className="text-[10px] text-plum/45 mt-0.5">Audit pass rate</p>
            <div className="mt-2.5 h-1.5 rounded-full bg-bloom overflow-hidden">
          ...
          <div
            className="absolute -bottom-2 right-3 lg:right-0 z-10 flex items-center gap-2 rounded-full border border-blush/80 bg-white shadow-lg pl-2 pr-4 py-1.5"
            style={{ animation: "float-b 6s ease-in-out 2s infinite" }}
          >
            <div className="flex -space-x-1">
              <div className="h-5 w-5 rounded-full bg-plum border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">M</div>
              <div className="h-5 w-5 rounded-full bg-mauve border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">S</div>
              <div className="h-5 w-5 rounded-full bg-rose border-2 border-white flex items-center justify-center text-[8px] font-bold text-white">A</div>
            </div>
            <span className="text-[10px] text-plum/50"><span className="font-bold text-plum/75">50+</span> advisors</span>
          </div>
        </div>
      </div>
    </section>
